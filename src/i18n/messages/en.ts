export const en = {
  ...
  sync: {
    title: 'Sync Center',
    subtitle: 'Review pending operations and conflicts from offline synchronization.',
    queueTitle: 'Pending queue',
    conflictsTitle: 'Conflicts',
    emptyQueue: 'No pending queue items.',
    emptyConflicts: 'No sync conflicts.',
    online: 'Online',
    offline: 'Offline',
    retryAll: 'Retry all',
    refresh: 'Refresh',
